...
public class DownArrow {
	...
	public class DownButtonTreeTable extends Button {
		private final String STYLE_NORMAL = "-fx-background-color: transparent; -fx-padding: 2, 2, 2, 2;";
    
	    public DownButtonTreeTable(double width, double height) {
	        ...
	        setOnAction(new OnMoveDown());
	        
	    }
	    
		public class OnMoveDown implements EventHandler<ActionEvent>{
